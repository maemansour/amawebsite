...
export function OurChapter() {
  ...
  return (
    <section className="py-16 md:py-20" data-testid="section-home-our-chapter">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-home-our-chapter">
            Our Chapter
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto" data-testid="text-home-chapter-mission">
          ...
          {offerings.map((offering, index) => {
            ...
            return (
              <Card 
                ...
                data-testid={`card-home-offering-${index}`}
              >
                <div className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-2" data-testid={`heading-home-offering-${index}`}>
                  {offering.title}
                </h3>
                <p className="text-muted-foreground" data-testid={`text-home-offering-${index}`}>
